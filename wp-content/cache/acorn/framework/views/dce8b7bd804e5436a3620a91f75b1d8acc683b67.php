...
<head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="<?= \Roots\asset('../images/icons/apple-touch-icon.png'); ?>">
    <link rel="alternate icon" type="image/png" sizes="32x32" href="<?= \Roots\asset('../images/icons/favicon-32x32.png'); ?>">
    <link rel="icon" type="image/svg+xml" sizes="16x16" href="<?= \Roots\asset('../images/icons/favicon.svg'); ?>">
            ...
            <?php if($query->have_posts()): ?>
                <div class="js-carousel flex-carousel slick-arrows-mt-[-45px]" data-slick='{
                    ...
                    "responsive": [
                        ...
                        <?php $__currentLoopData = $query->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                            <?php
                                $group = get_field('testimonial_group',$post->ID); 
                                $text = $group["text"];
                                $author_name = $group["author_name"];
                                $author_location = $group["author_location"];
                                $author_video_url = $group["author_video_url"];
                                $author_icon = $group["author_icon"]["url"];
                            ?>
                            ...
                            <div class="js-slide relative flex flex-col bg-white px-6 py-8 sm:px-8 md:p-4 pb-2 lg:pt-16 lg:px-12 lg:pb-1 transition duration-300 hover:shadow-xs mb-5 lg:mb-8">
                                <p class="font-light mb-8">“<?php echo e($text); ?>”</p>
                                <div class="flex items-center mt-auto mb-6">
                                    <img class="rounded-full flex-shrink-0 mr-4" src="<?php echo e($author_icon); ?>" width="60" height="60" alt="<?php echo e($author_name); ?>">
                                    <span class="text-gray-300 font-light text-[13px]"><?php echo e($author_name); ?>, <?php echo e($author_location); ?></span>
                                </div>
                                <div class="flex items-center justify-between border-t border-gray-400 py-5 min-h-[80px]">
                                    <a class="text-red-50 text-[13px] font-bold flex flex-shrink-0 items-center hover:text-red-500" href="<?php echo e($author_video_url); ?>">
        ...
        <div class="container pt-10 pb-6 md:pt-14 md:pb-8">
			...
			<div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5 py-8">
				<div class="flex items-center justify-center lg:justify-start p-6 lg:pl-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="<?= \Roots\asset('../images/partners/logo_swiss_visio.png'); ?>" width="210" height="90" alt="swiss visio">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="<?= \Roots\asset('../images/partners/logo_epfl.png'); ?>" width="140" height="42" alt="EPFL">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="<?= \Roots\asset('../images/partners/logo_canton_de_vaud.png'); ?>" width="188" height="58" alt="canton de vaud">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="<?= \Roots\asset('../images/partners/logo_fit.png'); ?>" width="210" height="65" alt="fit">
				</div>
				<div class="flex items-center justify-center lg:justify-end p-6 lg:pr-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="<?= \Roots\asset('../images/partners/logo_schweizerische.png'); ?>" width="251" height="63" alt="schweizerische">
				</div>
			</div>
		</div>
	</main><!-- /.main -->
...
</html><?php /**PATH C:\xampp\htdocs\wordpress\wp-content\themes\wootech\resources\views/testimonials-template.blade.php ENDPATH**/ ?>