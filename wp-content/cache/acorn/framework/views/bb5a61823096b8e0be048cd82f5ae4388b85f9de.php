...
<head>
    ...
    <link rel="icon" type="image/svg+xml" sizes="16x16" href="<?= \Roots\asset('images/favicon.ico'); ?>">
	<link rel="preconnect" href="https://fonts.googleapis.com">
	<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
	<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap">
	<link rel="stylesheet" type="text/css" href="<?= \Roots\asset('app.521c12.css'); ?>">
</head>
<body>
	<header x-data="{ isOpen: false }" class="bg-white border-b-4 border-gradient relative">
		<div class="container flex flex-wrap justify-between py-8">
			<a href="index.html" class="flex">
				<img src="<?= \Roots\asset('images/logo.svg'); ?>" width="140" height="73" alt="Medical">
			</a>
						...
						<div
							...
							<div class="md:container md:px-4 px-0">
								<ul
									...
									<li>
										<a href="testimonials-page/" class="block py-2 px-4 md:p-0 hover:bg-gray-400 md:hover:bg-transparent text-blue-100 md:text-white transition-colors duration-200 transform md:border-b-2 md:border-transparent md:hover:border-white md:uppercase">Testimonials</a>
									</li>
								</ul>
							</div>
						</div>
	...
	<?php
		$product1 = get_field('featured_product_1', 'option');
		$product2 = get_field('featured_product_2', 'option');
	?>
	<?php if($product1 AND $product2): ?>
		<div class="hero relative bg-white">
			<div class="absolute top-0 left-0 w-full h-[330px] md:h-full">
				<img class="absolute top-0 left-0 h-full mx-auto object-cover w-full" src="<?= \Roots\asset('images/home_banner.jpg'); ?>" width="1920" height="673" alt="hero">
			...
			<div class="container relative">
				<div class="md:flex md:flex-col md:h-full pt-6 md:pt-14">
					...
					<div class="grid gap-10 sm:gap-20 md:gap-8 mb-8 md:-mb-[72px] md:grid-cols-2">
						<a href="<?php echo e($product1["link"]); ?>" class="group flex flex-col relative bg-white bg-opacity-95 pt-4 md:pt-0 border-r-[10px] border-blue-100 shadow-xs" data-aos="fade-up" data-aos-delay="500" data-aos-duration="500">
							<img class="absolute -top-[23%] sm:-top-1/3 md:-top-1/4 right-1/2 sm:right-1/3 translate-x-1/2 md:translate-x-0 w-48 sm:w-2/4 px-2 md:px-0 md:w-auto md:right-14 md:ml-0" src="<?php echo e($product1["featured_image"]["url"]); ?>" width="212" height="173" alt="eyeview">
							<div class="py-6 px-5 md:py-6 md:px-8 pb-2 md:mb-4">
								<h2 class="text-[32px] mt-4 md:mt-8 mb-4 group-hover:underline"><?php echo e($product1["title"]); ?></h2>
								<p class="text-gray-100 font-light md:mb-4"><?php echo $product1["short_description"]; ?></p>
							</div>
						...
						<a href="<?php echo e($product2["link"]); ?>" class="group flex flex-col relative bg-white bg-opacity-95 pt-4 md:pt-0 border-r-[10px] border-blue-200 shadow-xs" data-aos="fade-up" data-aos-delay="800" data-aos-duration="500">
							<img class="absolute -top-8 sm:-top-16 md:-top-1/4 right-1/2 sm:right-1/3 translate-x-1/2 md:translate-x-0 w-48 sm:w-2/4 px-2 md:px-0 md:w-auto md:right-14 md:ml-0" src="<?php echo e($product2["featured_image"]["url"]); ?>" width="235" height="172" alt="eyecare">
							<div class="py-6 px-5 md:py-6 md:px-8 pb-2 md:mb-4">
								<h2 class="text-[32px] mt-4 md:mt-8 mb-4 group-hover:underline"><?php echo e($product2["title"]); ?></h2>
								<p class="text-gray-100 font-light md:mb-4"><?php echo $product2["short_description"]; ?></p>
							</div>
							<div class="bg-white mt-auto">
								<span class="flex items-center px-5 md:px-8 py-7 text-[13px] font-bold text-blue-200 group-hover:text-blue-100">
									<svg class="text-red-50 mr-3 transition ease-out duration-100 group-hover:translate-x-1" aria-hidden="true" focusable="false" width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<main class="main bg-main-home md:pt-24 lg:pt-48">
		<?php
			$blocks = get_field('gutenberg_blocks','option');
		?>
		<?php $__empty_1 = true; $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
			<?php if($block["image"]["position"] == 'left'): ?>
				<div class="relative flex flex-col pt-14 pb-7 lg:py-0 lg:flex-col">
					<div class="inset-y-0 top-0 left-0 w-full mb-8 lg:mb-0 lg:w-1/2 lg:pr-4 lg:absolute" data-aos="fade-up" data-aos-duration="1000">
						<img class="object-cover w-full h-full" src="<?php echo e($block["image"]["image"]["url"]); ?>" width="960" height="400" alt="<?php echo e($block["title"]); ?>">
					</div>
					<div class="container flex flex-wrap justify-end">
						<div class="lg:w-1/2 lg:pl-16 lg:pr-3 lg:py-12" data-aos="fade-up" data-aos-duration="500">
							...
							<h3 class="text-blue-200 text-[22px] mb-7"><?php echo e($block["tagline"]); ?></h3>
							<p class="text-lg font-light mb-8"><?php echo $block["description"]; ?></p>
							<div class="py-2 mb-4">
								<a  class="linline-block px-8 py-4 text-[13px] font-bold transition duration-200 text-white hover:text-white focus:text-white bg-blue-100 hover:bg-blue-100 focus:bg-blue-100 hover:shadow-xs focus:shadow-xs focus:outline-none" href="<?php echo e($block["learn_more"]["link"]); ?>"><?php echo e($block["learn_more"]["text"]); ?></a>
							</div>
						</div>
					</div>
				</div>
			<?php else: ?>
				<div class="relative flex flex-col pt-14 pb-14 lg:py-0 lg:flex-col bg-white">
					<div class="inset-y-0 top-0 right-0 w-full mb-8 lg:mb-0 lg:w-1/2 lg:pl-4 lg:absolute" data-aos="fade-up" data-aos-duration="1000">
						<img class="object-cover object-left-top w-full h-full" src="<?php echo e($block["image"]["image"]["url"]); ?>" width="960" height="400" alt="<?php echo e($block["title"]); ?>">
					</div>
		...
		<div class="relative">
			<img class="absolute inset-0 object-cover w-full h-full" src="<?= \Roots\asset('images/bg_get_in_touch.jpg'); ?>" width="1920" height="250" alt="get in touch">
		...
		<div class="container pt-10 pb-6 md:pt-14 md:pb-8">
			...
			<div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5 py-8">
				<?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					<?php if($key === 0): ?>
	...
	<footer class="footer bg-blue-100 bg-halftone text-white">
		...
		<div class="border-t border-white border-opacity-25">
			...
			<div class="flex items-center justify-center sm:justify-end">
					...
					<a href="#" target="_blank"><img src="<?= \Roots\asset('images/logo_hellenic-technologies.svg'); ?>" width="114" height="53" alt="Hellenic Technologies"></a>
				</div>
			</div>
		</div>
	</footer><!--/.footer -->
	...
	<script src="<?= \Roots\asset('app.js'); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\wordpress\wp-content\themes\wootech\resources\views/homepage-template.blade.php ENDPATH**/ ?>