...
<head>
    ...
    <link rel="alternate icon" type="image/png" sizes="32x32" href="@asset('../images/icons/favicon-32x32.png')">
    <link rel="icon" type="image/svg+xml" sizes="16x16" href="@asset('../images/icons/favicon.svg')">
                    ...
                    "responsive": [
                        ...
                        @foreach ($query->posts as $post) 
                            ...
                            <div class="js-slide relative flex flex-col bg-white px-6 py-8 sm:px-8 md:p-4 pb-2 lg:pt-16 lg:px-12 lg:pb-1 transition duration-300 hover:shadow-xs mb-5 lg:mb-8">
                                <p class="font-light mb-8">“{{$text}}”</p>
                                <div class="flex items-center mt-auto mb-6">
                                    <img class="rounded-full flex-shrink-0 mr-4" src="{{$author_icon}}" width="60" height="60" alt="{{$author_name}}">
                                    <span class="text-gray-300 font-light text-[13px]">{{$author_name}}, {{$author_location}}</span>
                                </div>
                                <div class="flex items-center justify-between border-t border-gray-400 py-5 min-h-[80px]">
                                    <a class="text-red-50 text-[13px] font-bold flex flex-shrink-0 items-center hover:text-red-500" href="{{$author_video_url}}">
        ...
        <div class="container pt-10 pb-6 md:pt-14 md:pb-8">
			...
			<div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5 py-8">
				<div class="flex items-center justify-center lg:justify-start p-6 lg:pl-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="@asset('../images/partners/logo_swiss_visio.png')" width="210" height="90" alt="swiss visio">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="@asset('../images/partners/logo_epfl.png')" width="140" height="42" alt="EPFL">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="@asset('../images/partners/logo_canton_de_vaud.png')" width="188" height="58" alt="canton de vaud">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="@asset('../images/partners/logo_fit.png')" width="210" height="65" alt="fit">
				</div>
				<div class="flex items-center justify-center lg:justify-end p-6 lg:pr-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="@asset('../images/partners/logo_schweizerische.png')" width="251" height="63" alt="schweizerische">
				</div>
			</div>
		</div>
	</main><!-- /.main -->
